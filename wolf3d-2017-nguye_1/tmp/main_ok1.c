...
** Last update Wed Jan  9 19:15:56 2013 alexandre1 nguyen
*/
...
int	calculs(img_param *param)
{
  ...
  param->x1 = 1;
  param->y1 = 0;
  param->x1 = param->x1 * cos(RAD(param->a)) - param->y1 * sin(RAD(param->a));
  param->y1 = (param->p * sin(RAD(param->a))) + (param->y1 * cos(RAD(param->a)));
